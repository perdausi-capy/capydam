...
import { Loader2 } from 'lucide-react'; // Removed Building2
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-8 shadow-2xl backdrop-blur-xl">
          <div className="relative">
            ...
            {/* ✅ SSO BUTTON WITH GOOGLE LOGO */}
            <button
                onClick={handleSSOLogin}
                type="button"
                className="group relative flex w-full items-center justify-center gap-3 rounded-xl border border-white/20 bg-white/5 p-3 transition-all duration-300 hover:bg-white hover:text-black hover:shadow-lg active:scale-[0.98]"
            >
                {/* Google Logo SVG */}
                ...
                <span className="font-semibold text-white/90 group-hover:text-black transition-colors">Log in with CapyTech</span>
            </button>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="group relative h-12 w-full overflow-hidden rounded-full bg-gradient-to-r from-[#3B73B9] to-[#5A8ED1] px-6 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:scale-[1.02] disabled:opacity-50"
              >
