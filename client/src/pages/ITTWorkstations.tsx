...
import {
    ...
    Camera, Headphones, Keyboard, Cable, Plug, Wifi, Mouse, Battery
} from 'lucide-react';
...
const WorkstationSpecs = ({
    ...
    const extendedOrder = ['MONITOR', 'PSU', 'WEBCAM', 'HEADSET', 'KEYBOARD', 'MOUSE', 'UPS', 'LAN_CABLE', 'CABLE_ADAPTOR', 'WIFI_ADAPTOR'];
...
const ITTWorkstations = () => {
    ...
    const [formData, setFormData] = useState({
        unitId: '', mobo: '', cpu: '', ram: '', gpu: '', psu: '', storage: '', monitor: '', webcam: '', headset: '', keyboard: '', mouse: '', ups: '', lanCable: '', cableAdaptor: '', wifiAdaptor: '', status: 'active', assignedUserIds: [] as string[]
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const allHardwareStrings = [
                ...
                formData.webcam, formData.headset, formData.keyboard, formData.mouse, formData.ups, formData.lanCable, formData.cableAdaptor, formData.wifiAdaptor,
            ...
            if (editingId) {
                const hardwareKeys = ['mobo', 'cpu', 'gpu', 'psu', 'webcam', 'headset', 'keyboard', 'mouse', 'ups', 'lanCable', 'cableAdaptor', 'wifiAdaptor'];
    ...
    const openModal = (ws?: Workstation) => {
        if (ws) {
            ...
            setInitialHardware({
                ...
                webcam: ws.webcam || '', headset: ws.headset || '', keyboard: ws.keyboard || '', mouse: ws.mouse || '', ups: ws.ups || '',
            ...
            setEditingId(null);
            setFormData({ unitId: '', mobo: '', cpu: '', ram: '', gpu: '', psu: '', storage: '', monitor: '', webcam: '', headset: '', keyboard: '', mouse: '', ups: '', lanCable: '', cableAdaptor: '', wifiAdaptor: '', status: 'active', assignedUserIds: [] });
            setInitialHardware({});
            setStorageItems(['']);
            setRamItems(['']);
            setMonitorItems(['']);
                        ...
                        <form onSubmit={handleSubmit} className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                ...
                                {([
                                    ...
                                    { label: 'UPS', key: 'ups', icon: <Battery size={16} />, invType: 'UPS' },
                                    ...
                                    const usedSns = [
                                        ...
                                        formData.webcam, formData.headset, formData.keyboard, formData.mouse, formData.ups,
