         ...
         <div className="flex items-center gap-4 flex-1 min-w-0">
             ...
             <div className="flex flex-col flex-1 max-w-2xl">
                 <input 
                    ...
                    className="text-lg font-bold text-gray-900 dark:text-white bg-transparent focus:bg-gray-50 dark:focus:bg-white/5 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900/30 rounded px-2 -ml-2 truncate border-transparent border hover:border-gray-200 dark:hover:border-white/10 transition-colors outline-none"
          ...
          <div className="mx-auto max-w-[1600px]">
            ...
            <div className="flex flex-col lg:flex-row min-h-[600px]">
                ...
                <div className="flex-1 bg-gray-50/50 dark:bg-[#121417] p-8 lg:p-12 flex items-start justify-center transition-colors">
                    <div className="relative rounded-[32px] overflow-hidden shadow-2xl ring-1 ring-black/5 dark:ring-white/10 bg-white dark:bg-[#1A1D21] max-w-full">
                        {asset.mimeType.startsWith('image/') ? (
                            <img src={asset.path} alt={asset.originalName} className="max-h-[70vh] w-auto object-contain" />
                        ) : asset.mimeType.startsWith('video/') ? (
                            <video controls src={asset.path} className="max-h-[70vh] w-auto" />
                        ) : (
                            <div className="h-96 w-96 flex flex-col items-center justify-center bg-gray-50 dark:bg-white/5">
                                <FileText size={64} className="text-gray-300 dark:text-gray-600 mb-4"/>
                                <span className="text-gray-500 dark:text-gray-400 font-medium">Preview Unavailable</span>
                            </div>
                        )}
                        <a href={asset.path} target="_blank" rel="noreferrer" className="absolute bottom-4 right-4 bg-white/90 dark:bg-black/80 p-2.5 rounded-full shadow-lg hover:scale-110 text-gray-700 dark:text-gray-200 backdrop-blur-sm transition-transform">
                ...
                <div className="w-full lg:w-[450px] border-l border-gray-100 dark:border-white/5 bg-white dark:bg-[#1A1D21] p-8 space-y-8 h-auto lg:min-h-screen transition-colors">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="w-full rounded-2xl border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-black/20 p-4 text-sm text-gray-700 dark:text-gray-200 focus:border-blue-500 dark:focus:border-blue-500 focus:ring-blue-500 outline-none resize-none transition-all placeholder-gray-400 dark:placeholder-gray-600"
                    ...
                    <div className="pt-6 border-t border-gray-100 dark:border-white/10">
                        ...
                        <div className="flex gap-2">
                            <div className="relative flex-1">
                                ...
                                >
                                    <option value="" className="text-gray-400">Select board...</option>
                ...
                <div className="border-t border-gray-100 dark:border-white/10 bg-white dark:bg-[#1A1D21] px-6 py-12 md:px-12 transition-colors">
                    ...
                    >
                        {related.map((item) => (
                            <div 
                                key={item.id} 
                                className="mb-6 break-inside-avoid rounded-2xl overflow-hidden cursor-pointer group relative shadow-sm border border-gray-100 dark:border-white/5 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1 transition-all duration-300"
                                onClick={() => {
